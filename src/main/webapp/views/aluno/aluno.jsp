            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="./aquisicao">Aquisição</a>
                    </li>
                </ul>
            </div>
        </div>
					...
					<jstl:forEach items="${listaAluno}" var="a">
						<tr>
							...
							<td>
								...
								<div class="d-flex">
										<a href="aluno-edit?id=${a.id}" class="mx-1" title="Editar">
											<i class="ri-file-edit-line"></i>
										</a> 
										<a href="aluno-delete?id=${a.id}" class="mx-1" title="Cancelar"
											onclick="return confirm('Deseja excluir o aluno ${a.nome}?')">
